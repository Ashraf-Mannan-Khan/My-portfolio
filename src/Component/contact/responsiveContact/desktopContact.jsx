import styles from '../responsiveCss/desktopContact.module.css';
    ...
    return (
        ...
        <section className={styles.conatiner}  >
            ...
            <a href="mailto:ashrfkhn97@gmail.com" target="_blank" className={styles.information}>  
                    <p>Email</p>
                <p className={`${styles.arrow} ${styles.leftMargin}`}>ashrfkhn97@gmail.com</p>
            </a>
