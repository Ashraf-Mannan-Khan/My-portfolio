...
import styles from "../responsiveCss/desktop.module.css";
import { Outlet } from "react-router-dom";

export function DesktopBody(props) {
      ...
      <div className={styles.body}>
        <div className={styles.info_div}>
          ...
          <p className={styles.paragraph}>
            Frontend developer focused on <span>thoughtful UI</span> and smooth
            interactions. I build experiences that feel <span>light</span>,{" "}
            <span>purposeful</span>, and never demand more attention than
            <span> they deserve</span>.
          </p>
          <p className={styles.paragraph}>
            I am a Frontend developer from <span className={styles.india}><b>India</b></span>.
          </p>
          <p className={styles.paragraph}>
